...
def main():
    ...
    print(
        f"Tokens used: {response.input_tokens} input, {response.output_tokens} output"
    )
    print("=" * 100)
    ...
    response2 = query_model(model_id="B", query=conversation)
    ...
    print(
        f"Tokens used: {response2.input_tokens} input, {response2.output_tokens} output"
    )
    print("=" * 100)
